...
namespace NailCourse.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260924112639_AddSpotPlayerLicense")]
    partial class AddSpotPlayerLicense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.LessonProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.SpotPlayerLicense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NailCourse.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NailCourse.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.Course", b =>
                {
                    b.HasOne("NailCourse.Domain.Entities.Category", "Category")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.LessonProgress", b =>
                {
                    b.HasOne("NailCourse.Domain.Entities.Lesson", "Lesson")
                        .WithMany()
            ...
            modelBuilder.Entity("NailCourse.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("NailCourse.Domain.Entities.Order", "Order")
                        .WithMany("Items")
